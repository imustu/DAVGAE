...
def walk_main(args):
	#args.input = 'data/edges_example.txt'
#array_gd只包含g-d关系
#array_all包含g-d和g-g关系
	#args.input = 'data/array_all_5_2.txt'#改
	#args.output = 'data/walks_fornewdata.txt'
	#args.output = 'data/walks_newHer.txt'
	args.input = 'datasetA/edges_gd.txt'#改
	args.output = 'datasetA/gd_walks.txt'
	args.num_walks = 40
	args.walk_length = 40
	#args.num_walks = 60
	#args.walk_length = 60
