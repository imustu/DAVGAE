...
def learn_embeddings(walks):
    ...
    model = Word2Vec(sentences, window=args.window_size, min_count=0,
                     workers=args.workers, negative=25, sg=1,vector_size=args.dimensions)
...
def emb_main(args):
    ...
    args.input = 'datasetA/gd_walks.txt'
    args.output = 'datasetA/gd_emb.txt'
    args.model = 'datasetA/gd_emb.model'
    #args.dimensions = 128
    #args.iter = 5
    args.dimensions = 128*2
